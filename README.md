...
Il motore locale v32 separa due decisioni:
...
La composizione limita anche la fatica sistemica: fino a 30 minuti usa normalmente 2 movimenti primari e 1 accessorio; sotto i 60 minuti non supera 2 movimenti primari e da 60 minuti non supera 3. Il fly resta un isolamento accessorio. Una seduta normale non viene chiusa a due soli esercizi quando esiste un terzo accessorio compatibile e recuperato; in quel caso viene aggiunta una dose di mantenimento entro la tolleranza temporale. Ogni prescrizione viene ridotta o esclusa prima dell'inserimento se non entra nel budget. Il carico pianificato viene aggiornato dopo ogni scelta, così gli accessori non ignorano lo stimolo già assegnato dai movimenti primari. Se cambia un’impostazione che influenza la prescrizione — obiettivo, livello, stile, attrezzatura, carichi disponibili, durata, filtri o override — la scheda pronta viene rigenerata automaticamente. Lingua e configurazione del backup non la invalidano; un workout già aperto non viene sostituito durante l’esecuzione. Il refresh può cambiare gli esercizi soltanto se conserva le medesime famiglie adattive, la composizione, il recupero e tutti i vincoli correnti. Dopo ogni generazione o refresh l’utente può aggiungere un esercizio compatibile oppure rimuoverlo dal menu della relativa scheda.
...
- stato per gruppo muscolare con prontezza, percentuale di stimolo coperto e indicazione esplicita dei target scelti per il prossimo workout;
