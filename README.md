...
Il motore locale v33 separa due decisioni:
...
2. **Prescription** — distribuisce la dose mobile a decadimento graduale sulle esposizioni ancora necessarie e applica una doppia progressione individuale a serie, ripetizioni, RIR, pause e carico. In multifrequenza preferisce entro sette giorni un pattern complementare della stessa famiglia e della stessa classe: dopo una tirata verticale cerca quindi una tirata orizzontale, purché obiettivo e attrezzatura siano compatibili. Solo quando il complemento non esiste ripiega su un'altra variante dello stesso pattern; ogni variante resta misurabile per quattro utilizzi prima della rotazione. Le progressioni confrontano il volume realmente completato dell’intero esercizio con quello prescritto, sia come ripetizioni totali sia come peso × ripetizioni; il minimo della singola serie resta un segnale prudenziale, ma non può più cancellare un surplus complessivo. Gli accessori per bicipiti e tricipiti vengono confrontati globalmente sulla dose residua. Un multiarticolare generato mantiene almeno due serie salvo override esplicito. La durata scelta è indicativa e ammette fino a sette minuti di tolleranza per non tagliare lavoro utile. I workout attivi creati da un engine precedente vengono migrati conservando tempi, valori manuali e qualunque serie già completata. Lo stile scelto dall'utente definisce una sequenza RIR e un tetto di serie diversi per multiarticolari ad alta fatica, multiarticolari stabili e isolamenti; nello stile Essenziale intenso gli isolamenti usano tre serie con progressione RIR 2 → 1 → 0. Se l’utente modifica il numero di serie, la curva viene ridistribuita sull’intero esercizio. L'obiettivo forza mantiene prudenzialmente un RIR aggiuntivo sui multiarticolari ad alta fatica.
