...
Il motore locale v34 separa due decisioni:
...
La composizione limita anche la fatica sistemica: fino a 30 minuti usa normalmente 2 movimenti primari e 1 accessorio; sotto i 60 minuti non supera 2 movimenti primari e da 60 minuti non supera 3. Il fly resta un isolamento accessorio. Quando esistono almeno tre esercizi compatibili, una seduta normale non viene chiusa a due: il terzo viene inserito anche se la stima supera di poco la durata richiesta. Il carico pianificato viene aggiornato dopo ogni scelta, così gli accessori non ignorano lo stimolo già assegnato dai movimenti primari. Se cambia un’impostazione che influenza la prescrizione — obiettivo, livello, stile, attrezzatura, carichi disponibili, durata, filtri o override — la scheda pronta viene rigenerata automaticamente. Lingua e configurazione del backup non la invalidano; un workout già aperto non viene sostituito durante l’esecuzione. Il refresh conserva target di stimolo, composizione e vincoli correnti. Dopo ogni generazione o refresh l’utente può aggiungere un esercizio compatibile oppure rimuoverlo dal menu della relativa scheda.
