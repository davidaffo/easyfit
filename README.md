...
- Completare esattamente peso, reps e RIR prescritti conferma il massimale corrente e non inventa automaticamente `+1 rep`. Superare il volume oppure terminare l’ultima serie con più RIR aggiorna il massimale; peso e reps successivi vengono ricalcolati da quella nuova capacità. Quando il carico corrente raggiunge il limite alto del range, viene provato il più piccolo carico superiore dichiarato dall’utente, purché il salto non superi il 10% e consenta ancora il minimo di ripetizioni.
...
- A parità di carico e RIR, un target fallito non può generare più ripetizioni nella seduta successiva: scegliendo stanchezza occasionale viene ripetuta la prescrizione precedente, mentre scegliendo la ricalibrazione il nuovo totale non supera le ripetizioni effettivamente completate. Soltanto un target raggiunto o superato può avanzare, al massimo di una ripetizione totale quando l’evidenza deriva dal solo volume complessivo.
